...
if ($accion == "registrarPersona") {
    ...
    //     header("Location:../registrarse");
    // }else{
    //     $consulta_string = "INSERT INTO empresa (Eruc, ErazonSocial, EnombreComercial, Ecelular, ecorreo,password, EfechaRegistro,estado) 
    //     VALUES ('$re_ruc','$re_razonSocial', '$re_nombreComercial', '$re_numeroContacto', '$re_email', sha1('$re_password'), curdate(),'1');";
