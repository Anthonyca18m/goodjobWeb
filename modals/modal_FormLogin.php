                        ...
                        <form action="Model/validarSesion" id="frmSignIn" method="post" class="contact-form">
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input id="LoginUser" name="LoginUser" type="text" required class=" form-control ">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="submit" value="Entrar" class="btn btn-primary float-right" data-loading-text="Loading...">
                                </div>
                            </div>
                        </form>
