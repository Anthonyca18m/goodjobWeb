...
<body>
            ...
            <div class="container py-2">
                <div class="row py-4">
                    <div
                        ...
                        <a href="index" class="logo pr-0 pr-lg-3"> <img alt="Porto Website Template"
                    ...
                    <div class="col-lg-4 d-flex align-items-center justify-content-center justify-content-lg-end">
                        <nav id="sub-menu">
                            <ul>
                                <li><i class="fas fa-angle-right"></i><a href="faqs" class="ml-1 text-decoration-none">
                                        FAQ's</a></li>
    ...
    <script src="master\style-switcher\style.switcher.js" id="styleSwitcherScript" data-base-path="" data-skin-src="">
    </script>
