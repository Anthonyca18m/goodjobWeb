...
<head>
    ...
    <link rel="apple-touch-icon" href="goodjob/logo.png">
    ...
    <link rel="stylesheet" href="css\theme-blog.css">
    <link rel="stylesheet" href="css\theme-shop.css">

    <!-- Current Page CSS -->
    <link rel="stylesheet" href="vendor\rs-plugin\css\settings.css">
    <link rel="stylesheet" href="vendor\rs-plugin\css\layers.css">
    <link rel="stylesheet" href="vendor\rs-plugin\css\navigation.css">
                                        ...
                                        <div class="col-md-12">
                                            <div class="featured-box featured-box-primary text-left mt-2">
                                                <div class="box-content p-5">
                                                    ...
                                                    <form id="formRegistrasePersona" method="POST" action="Model/register.php">
                                                        <input type="hidden" name="accion" value="registerPersona"/>
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                <input type="submit" value="Registrar" class="btn btn-primary float-right" data-loading-text="Loading...">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                    ...
                    <div class="container py-2">
                        <div class="row py-4">
                            <div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
                                <a href="" class="logo pr-0 pr-lg-3"> <img alt="Porto Website Template" src="goodjob/logo_grande.png" class="opacity-5" height="50"> </a> </div>
                            ...
                            <div class="col-lg-4 d-flex align-items-center justify-content-center justify-content-lg-end">
                                <nav id="sub-menu">
                                    <ul>
                                        <li><i class="fas fa-angle-right"></i><a href="faqs" class="ml-1 text-decoration-none"> FAQ's</a></li>
                                        <li><i class="fas fa-angle-right"></i><a href="ubicanos" class="ml-1 text-decoration-none"> Ubicanos</a></li>
                                        <li><i class="fas fa-angle-right"></i><a href="contactanos" class="ml-1 text-decoration-none"> Contáctanos</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
